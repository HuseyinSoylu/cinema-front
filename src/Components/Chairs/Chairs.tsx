...
const Chairs = () => {
  const { chair, setChair, selectedChair, setSelectedChair } =
    useContext(ChairContext);
  ...
  localStorage.setItem("chair", JSON.stringify(selectedChair));
  return (
    <div className="row flex-row">
      ...
      <div className="perde mt-5 mb-3">Screen</div>
    </div>
  );
};
